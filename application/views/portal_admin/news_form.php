...
<?php
	...
	if(isset($combo_kategori)){
		foreach ($combo_kategori as $cmb) {
			$cmb_data[$cmb['id']] = $cmb['nama_kategori'];
		}
	}
...
<article class="module width_full">
	...
	<?php echo form_open_multipart('portal_admin/content/save_news');?>
	<div class="formee">
        <div class="grid-12-12">
               <label>Kategori <em class="formee-req">*</em></label>
				<?php echo form_dropdown('kategori', $cmb_data, $kategori_id,'id="kategori"  style="width:92%;"'); ?> 
				<input type='hidden' name='hidden_id' id='hidden_id' value="<?php echo $hidden_id;?>">
				<input type='hidden' name='hidden_menu_id' id='hidden_menu_id' value="<?php echo $menu_id;?>">
        </div>
		<div class="grid-12-12 clear">
                <label>Judul <em class="formee-req">*</em></label>
               <input type="text" id="judul" name="judul" style='width: 92%;' value='<?php echo $judul;?>' />
        </div>
		<div class="grid-12-12 clear">
		...
		<div class="grid-12-12">
               <label>Gambar</label>
			   <?php if($gbr!=""){echo "<img src='./portal_assets/admin/images/news/".$gbr."'/><input type='checkbox' name='del_image' value='delete' /> Delete Image";}else{echo "No Image";}?>
		</div>
		<div class="grid-12-12">
